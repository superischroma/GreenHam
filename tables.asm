...
TickTable:
    .word 0, 0, 0, BananaTick, 0, BlackHoleTick, SpeedsterTick, RainingObjTick, RainingObjTick, BananaTick, BlackHoleTick, RainingObjTick, GravitorTick, ThundercloudTick, 0, 0, 0, 0, 0, 0, BubbleGeneratorTick, 0, NeedleTick, 0
